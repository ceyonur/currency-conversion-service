...
public enum ServiceCurrency {
	...
	ServiceCurrency(String code, String description) {
		this.code = code;
        this.description = description;
	}

	public static ServiceCurrency fromCode(String code) {
		for (ServiceCurrency cur : ServiceCurrency.values()) {
			if (cur.name().equalsIgnoreCase(code)) {
				return cur;
			}
		}
